...
const routes = [
  ...
  { path: '/orders', name: 'Orders', component: placeholder('订单管理'), meta: { page: 'orders' } },
  { path: '/process-flow', name: 'ProcessFlow', component: placeholder('工艺流程'), meta: { page: 'process_flow' } },
...
router.beforeEach(async (to, _from, next) => {
  ...
  // Admin bypasses frontend permission checks (matches backend behavior)
  ...
  if (page) {
    ...
    if (!perm || !perm.can_view) {
      // Redirect to first accessible page instead of hardcoded '/'
